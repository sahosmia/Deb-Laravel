                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.permissions.update', $data->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="module_id">
                                        ...
                                        @forelse ($modules as $item)
                                            <option @selected($item->id == old('module_id', $data->module_id)) value="{{ $item->id }}">
                                                {{ $item->title }}
                                            </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="professional_name" value="{{ old('professional_name', $data->professional_name) }}" class="form-control">
                                </div>
