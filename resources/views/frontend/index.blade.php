...
<html lang="en">
  <head>
    ...
    <link
      rel="shortcut icon"
      href="{{ asset('frontend/assets/img/logo/Final Logo DEB-ai (4).png') }}"
      type="image/x-icon"
    />
    ...
    <link
      rel="stylesheet"
      href="{{ asset('frontend/assets/vendor/css/owl.theme.default.min.css') }}"
    />
      ...
      <!-- <nav>
        <div class="d-flex justify-content-between container">
          <div class="logo">
            <a href="index.html"
              ><img
                src="{{ asset('frontend/assets/img/logo/Final Logo DEB-ai (1).png') }}"
                alt="Navber logo"
            /></a>
          </div>
          <div class="menu">
            ...
            <div class="col-md-6 m-auto">
              <div class="section_content" data-aos="zoom-in"  data-aos-duration="1000">
                <h3 class="section_heading">
                  Course <span class="primary_color">Category</span>
                </h3>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt,
                  exercitationem? Delectus nemo, quas neque totam voluptates.
        ...
        <div class="container">
          ...
          <div class="row" data-aos="fade-up" data-aos-duration="1000">
            <div class="col-md-6">
              <img
                class="w-75"
                src="{{ asset('frontend/assets/img/why-choose/why_choose.jpg') }}"
                alt="why_choose"
              />
            </div>
