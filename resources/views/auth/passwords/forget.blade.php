...
@section('content')
    ...
    <div class="form_side col-md-6">
       ...
       @include('auth.layouts.status')
        ...
        <form  method="POST" action="{{ route('passwordForgetSubmit') }}">
            @csrf
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Email address</label>
                <input name="email" type="text" class="form-control @error('email') is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp">
